let topics = [
  { 
    ...
    description: "백엔드는 서버 측 개발을 담당하며, 데이터 처리와 로직을 구현합니다. 신속하고 정확한 서버를 구축하여 웹 어플리케이션을 지원합니다.",
  ...
  { 
    ...
    description: "프론트엔드는 사용자와 상호작용하며, 웹 디자인과 사용자 경험을 구현합니다. HTML, CSS, JavaScript를 활용하여 웹페이지를 개발합니다.",
  ...
  { 
    ...
    description: "웹은 정보를 전달하고 공유하는 수단으로, 전 세계적으로 연결된 컴퓨터 네트워크를 기반으로 합니다. 다양한 리소스에 접근 가능합니다.",
  ...
  { 
    ...
    description: "웹의 구조는 클라이언트와 서버 간의 통신을 기반으로 합니다. 웹 브라우저, 서버, 데이터베이스 등이 상호작용하여 동작합니다.",
  ...
  { 
    ...
    description: "협업은 팀원 간의 소통과 협력을 강조하는 과정입니다. GitHub를 통한 협업은 프로젝트의 효율성을 높이는 데 중요한 역할을 합니다.",
  ...
  { 
    ...
    description: "디자인은 사용자 경험을 개선하고 시각적인 아름다움을 제공합니다. Figma와 같은 도구를 활용하여 디자인을 구현합니다.",
...
function updateContent() {
  ...
  document.querySelector("#course_explain").innerHTML = currentTopic.description;
